...
if ( ! function_exists( 'brand_has_post_thumbnail' ) ) :
/**
 * Checks for the featured image.
 *
 * @since 1.0.0
 */
function brand_has_post_thumbnail() {
	global $post;
	...
	if ( ! is_singular() ) {
		if( has_post_thumbnail() && $brand_settings['show_thumb_index'] === 'yes') {
			return true;
		}
	} else {
		if( has_post_thumbnail() && $brand_settings['show_thumb_single'] === 'yes') {
			return true;
		}
	}
	return false;
